echo "我是Alimtech，现在为您安装ROS-melodic，如安装过程中遇到问题，欢迎关注微信公众号《嗨钛科技》，加入嗨钛群交流"
echo "现在Alimtech开始为您导入秘钥"
...
echo "Alimtech提示：已完成安装ROS，正在检查环境..."
sudo cat ~/.bashrc | grep melodic/setup.bash
if [ $? -ne 0 ];then
  echo "Alimtech提示：正在为您添加环境设置...."
  echo "source /opt/ros/melodic/setup.bash" >> ~/.bashrc; 
fi
source /opt/ros/melodic/setup.bash
echo "Alimtech提示：已为您完成所有操作，如果失败了请重新尝试或关注公众号《嗨钛科技》加入嗨钛群"
